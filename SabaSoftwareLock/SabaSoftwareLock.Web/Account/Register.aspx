<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="SabaSoftwareLock.Web.Account.Register" %>
            ...
            <asp:Panel ID="Panel1" runat="server">
                ...
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtPasswordConfirm" runat="server" TextMode="Password"></asp:TextBox>
                    ...
                    <tr>
                        <td><asp:Button ID="btnRegister" runat="server"  Text="ثبت نام" 

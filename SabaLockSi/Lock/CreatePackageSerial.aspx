...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" BorderColor="Gray" BorderStyle="Solid" style="padding: 5px;">
        ...
        <telerik:RadNumericTextBox runat="server" ID="txtCount" >
        ...
        <telerik:RadNumericTextBox ID="txtUsingCount" runat="server" >
            <NumberFormat DecimalDigits="0" GroupSeparator="" NegativePattern="" 
                ZeroPattern="n" />
        </telerik:RadNumericTextBox>
        ...
        <telerik:RadNumericTextBox ID="txtSerialLen" runat="server" Value="8">
            <NumberFormat DecimalDigits="0" GroupSeparator="" NegativePattern="" 
                ZeroPattern="n" />
        </telerik:RadNumericTextBox>
        ...
        <telerik:RadComboBox ID="cmbSoftName" runat="server" AllowCustomText="True" AutoCompleteSeparator="," AutoPostBack="False"></telerik:RadComboBox>
        ...
        <asp:Label ID="lblTrackingCode" runat="server" title="کد رهگیری :‌ " style="margin-right: 5px;"></asp:Label>
